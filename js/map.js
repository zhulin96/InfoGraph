...
var fields = [
      //{name: "(no scale)", id: "none"},
        //{name: "percent", id: "percent", key: "percent_%d", years: [14, 29, 44,59,74]},
        //{name: "Mujeres", id: "mujeres", key: "mujeres_%d", years: [2002, 2005, 2010]},
		//{name: "Number of languages", id: "nrlangs", key: "NRLANGUAGES%d", years: [2010]},
		{name: "Age", id: "Age", key: "Age%d", years: [14, 29, 44,59,74]},
	
       ],
    years =[14, 29, 44,59,74],
    fieldsById = d3.nest()
...
d3.json("https://raw.githubusercontent.com/timelyportfolio/rCharts_cartogram/gh-pages/worldcountries.topojson", function(topo) {
  topology = topo;
  ...
  d3.csv("https://raw.githubusercontent.com/zhulin96/InfoGraph/master/data/cancer_new.csv", function(data) {
...
function init() {
  ...
  mapFeatures = mapFeatures.data(features)
    ...
    .append("path")
      .attr("class", "obesidad")
      .attr("id", function(d) {
        //return d.properties.percent_14;
      })
      .attr("fill", "#fafafa")
      .attr("d", path);
